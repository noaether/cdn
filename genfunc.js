...
(async () => {
    try {
        ...
        for (const file of apiFiles) {
            ...
            const response = await fetch(`https://cdn.noae.ca/.netlify/functions/${api.module.example}`);
        ...
        for (const file of apiFiles) {
            ...
            array.push({
              ...
              url: `https://cdn.noae.ca/.netlify/functions/${api.module.name}`,
              params: Array(api.module.params).join(' '),
              example: `https://cdn.noae.ca/.netlify/functions/${api.module.example}`
            })
          }
        console.log(aray);
        console.log(array);
